...
- <nomComplet1>Julien Le Blanc</nomComplet1>
- <courriel1>julien.le-blanc.1@ens.etsmtl.ca</courriel1>
- <codeMoodle1>AT67750</codeMoodle1>
- <githubAccount1>Julien2105</githubAccount1>
...
1. Le Système affiche le nom du joueur et le résultat de la partie, ainsi que le nombre de parties et le nombre de fois que le Joueur a gagné. Pour un lancer, si le total est plus petit ou égal à dix, le Joueur a gagné. Dans tous les autres cas, il a perdu.
...
- d3.valeur est devenue un nombre entier aléatoire entre 1
